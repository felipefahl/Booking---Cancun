...
public class BookingOrderAvailabilityProducer : KafkaProducer<BookingOrderDomain>, IBookingOrderAvailabilityJob
{
    public BookingOrderAvailabilityProducer(ILoggerManager logger, ICapPublisher kafka)
        : base(logger, kafka, nameof(BookingOrderAvailabilityProducer))
    {
    }
